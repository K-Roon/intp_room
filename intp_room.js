...
// 버전, 정보, 관리자상수화 등
var VERSION = "5.7";
var TARGET_ROOM = "여름이다! 인팁•인티제의 MBTI 수다방[타유형 대환영]";
var ADMIN_NAMES = ["권재현"];
...
var QUIZ_BANK = [
    ...
    { q: "[041] [IT] Compact Disc 의 약자로서, 원판에 레이저로 정보를 저장하고 읽는 매체를 무엇이라고 하는가?", a: ["CD", "씨디"], hint: "이 매체에다가 기록하는 행위를 '버닝' (굽기) 라고 합니다. 사실 Compact Disc의 이니셜을 쓰면 그게 정답입니다." },
